...
//	// Add new role
//	@PostMapping("/add")
//	public ResponseEntity<?> add(@RequestBody NhanVien addRole) {
//		NhanVien dataRole = nhanVienService.addRole(addRole);
//		
//			if (dataRole != null) {
//				return new  ResponseEntity<>(dataRole, HttpStatus.OK);
//			}
//			else {
//			return createErrorResponse("Khong them moi duoc", HttpStatus.NOT_FOUND);
//		}
//	}
//
